...
class Val {
  static String validateTitle(String val) =>
      (val != null && val != "") ? null : "Title cannot be empty";
  ...
  static bool strToBool(String str) => (int.parse(str) > 0) ? true : false;

  static bool intToBool(int val) => (val > 0) ? true : false;

  static String boolToStr(bool val) => (val == true) ? "1" : "0";

  static int boolToInt(bool val) => (val == true) ? 1 : 0;
}
